    ...
    <section id="gifts" className="gifts-section">
      ...
      <div className="gifts-content">
        <p className="gifts-text">
          ...
          No entanto, para quem quer ajudar no inicio da nossa vida de casados ou para a nossa lua de mel deixamos o nosso IBAN.
        </p>
        ...
        <div className="inline" style={{marginLeft:"15px"}}>
          <img src="img/safari.png" className="bank-icon" />
          <img src="img/vacation.png" className="bank-icon" />
          <img src="img/coffee.png" className="bank-icon" />
          <img src="img/flowers.png" className="bank-icon" />
        ...
        <a href="https://vistaalegre.com/pt/CustomerList/83edb694-ade5-4954-a06d-399a9c801b2a" target="_blank" rel="noopener noreferrer" className="vista-alegre-btn disabled">
          Ver Lista na Vista Alegre
        </a>
        <p>Código de Acesso: 25072026</p>
      </div>
    </section>
  );
};
